...
def build_docs():
    ...
    python_call(
        "ipykernel", ["install", "--user", "--name=kaggle_house_price_prediction"]
    )
    ...
    call(
        [
            ...
            "-o",
            "docs/source",
            "src/kaggle_house_price_prediction",
        ]
    )
...
def convert_notebook(all_flag, overwrite_flag, filepath):
    ...
    *Note*: Make sure your notebooks have unique names!
    ...
    """
    from kaggle_house_price_prediction.run import ProjectContext
    ...
    kedro_package_name = "kaggle_house_price_prediction"
